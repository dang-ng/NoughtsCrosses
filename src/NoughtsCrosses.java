...
public class NoughtsCrosses {
    ...
    private void winningGame() {
        // for player x only
        if (b1 == 1 && b2 == 1 && b3 == 1) {
            JOptionPane.showMessageDialog(frame, "Player X Wins", "Noughts & Crosses", JOptionPane.INFORMATION_MESSAGE);
            xCount1++;
        ...
        // For Player O Only//
            ...
            JOptionPane.showMessageDialog(frame, "Player O Wins", "Noughts & Crosses", JOptionPane.INFORMATION_MESSAGE);
            oCount1++;
            ...
            JOptionPane.showMessageDialog(frame, "No One Wins", "Noughts & Crosses", JOptionPane.INFORMATION_MESSAGE);
